...
let cannonSfx = new Audio("https://ia903405.us.archive.org/1/items/metal-block/Anti%20Aircraft%20Cannon-18363-Free-Loops.com.mp3")
...
class CannonBalls {
    constructor(angle, x, y) {
        ...
        this.elasticity = 0.5;
        this.friction = 0.008;
        this.collAudio = new Audio("https://ia803405.us.archive.org/28/items/metal-block_202104/metal-block.wav");
...
function ballHitBall(ball1, ball2) {
    ...
    if (distance <= (ball1.radius + ball2.radius) * (ball1.radius + ball2.radiuss)) {
        collision = true;
    }
    return collision;
}
function collideBalls(ball1, ball2) {
    ...
    ball2.dx += (impulse * ball1.mass * vCollisionNorm.y);
...
canvas.addEventListener("click", e => {
    ...
    cannonBalls.push(
        new CannonBalls(angle, ballPos.x, ballPos.y)
    );
